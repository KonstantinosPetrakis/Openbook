...
def process_put_patch(get_response: Callable) -> Callable:
    """
    This is a middleware that processes PUT and PATCH requests with content types other than application/json.
    I copied this from the following issue:
    https://github.com/vitalik/django-ninja/issues/1059#issuecomment-1904178553
    """
